"""
URL configuration for db_carte project.
...
urlpatterns = [
    ...
    path('api/packs/', include('packs.urls')),  # Include gli URL dell'app "packs"
    path('api/exchange/', include('exchange.urls')),  # Include gli URL dell'app "exchange"
] 
